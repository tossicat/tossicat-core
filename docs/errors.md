...
|ValueError|102|InvalidCharacter|올바른 한글 문자가 아닙니다. <br/> This value is not a valid Hangul character|
|ValueError|103|LimitLength|단어 길이가 50를 초과합니다. <br/> The length has been exceeded. Set the word length to less than 50|
|ParseError|201:101|InvalidValue(InvalidTossi)|파싱된 토씨가 올바르지 않습니다. ValueError를 반환합니다. <br/> Return to ValueError|
|ParseError|201:102|InvalidValue(InvalidCharacter)|파싱된 문자가 올바른 한글이 아닙니다. ValueError를 반환합니다. <br/> Return to ValueError|
|ParseError|201:103|InvalidValue(LimitLength)|파싱된 단어 길이가 50을 초과합니다. ValueError를 반환합니다. <br/> Return to ValueError|
...
|ParseError|206|SplitTossiWord| 토씨와 단어가 쉼표(,)로 나눠져있지 않습니다. <br/>The sentence can not be parsed. Please separate words and tossi with a comma.|
