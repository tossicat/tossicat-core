...
- 숫자를 한글로 변환
- 총 123개의 토시 처리 가능 (변환 필요 토시 90개 + 불변 토시 33개)
...
| identifier.rs | 205 | 토시 종류 판별 및 변환 방식 결정 |
| tossi.rs | 185 | 처리 가능한 토시 목록 정의 (123개) |
...
| 파일 | 테스트 수 | 내용 |
|------|-----------|------|
| tests/lib.rs | 15 | `modify_sentence`, `postfix`, `transform` 통합 테스트 |
