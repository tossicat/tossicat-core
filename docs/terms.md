...
- "지", "이지": `Ji`
- "지만", "이지만": `Jiman`
- "니까", "이니까": `Nikka` # 앞의 Ka, Deunka와 맞추기 위해서 "kka"를 사용했습니다.
- "건", "이건": `Geon`
- "거든", "이거든": `Geodeun` # 앞의 Deun과 맞췄습니다.
- "거나", "이거나": `Geona`
- "냐", "이냐": `Nya`
- "라면", "이라면": `Ramyeon`
- "라서", "이라서": `Raseo` # 앞의 Roseo와 맞췄습니다.
- "라는", "이라는": `Raneun` # 앞의 Neun과 맞췄습니다.
- "에요/예요", "이에요": `Eyo`
- "었다/였다", "이었다": `Eotda`
- "어서/여서", "이어서": `Eoseo` # 앞의 Roseo와 맞췄습니다.
- "로의", "으로의": `Roui`
- "라니", "이라니": `Rani`
- "란다", "이란다": `Randa`
- "라면서", "이라면서": `Ramyeonseo` # 앞의 Ramyeon과 맞췄습니다.
- "라든가", "이라든가": `Radeunka` # 앞의 Deunka와 맞췄습니다.
- "라든지", "이라든지": `Radeunji` # 앞의 Deunji와 맞췄습니다.
- "요", "이요": `Yo`
